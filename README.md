...
```bash
curl -sSL https://raw.githubusercontent.com/Andrew96bit/nexus-prover/refs/heads/main/nexus.sh | bash
```
- Or this command to run this script
```bash
wget -qO - https://raw.githubusercontent.com/Andrew96bit/nexus-prover/refs/heads/main/nexus.shh | bash
```
